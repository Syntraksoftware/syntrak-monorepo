export function RaycastLogoIcon({ className = "h-8 w-8" }: { className?: string }) {
  return (
    <svg
...
export function RaycastLogoFull({ className = "h-6" }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      ...
      aria-label="Raycast"
    >
      <g clipPath="url(#raycast-logo-full)">
        <path
          fill="#FF6363"
          fillRule="evenodd"
